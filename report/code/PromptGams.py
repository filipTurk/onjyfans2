...
class ModelInference:
    """
    A class to handle loading a model and running inference.
    """
    def __init__(self, model_path: str):
        ...
        logger.info(f"🚀 Initializing Inference for model: {self.model_path}")
        start_time = time.time()
        
        try:
            # 1. Load Quantization Config (same as training)
            ...
            self.model = AutoModelForCausalLM.from_pretrained(
                ...
                device_map="auto" # Automatically handles GPU distribution
            )
            self.model.config.use_cache = True # Enable cache for faster inference
            ...
            self.pipeline = pipeline(
                ...
                # You can add default generation parameters here if you want
...
if __name__ == "__main__":
    ...
    # Use "./outputs" for your fine-tuned model.
    # Use "cjvt/GaMS-9B-Instruct" for the base model.
    MODEL_PATH = "./outputs" 
